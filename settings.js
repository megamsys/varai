...
module.exports = {
    // the tcp port that the varai web server is listening on
    uiPort: 1880,

    // By default, the varai UI accepts connections on all IPv4 interfaces.
    // The following property can be used to listen on a specific interface. For
    // example, the following would only allow connections from the local machine.
   // uiHost: "127.0.0.1",
     uiHost: process.env.VARAI_HOST,
    ...
    // By default, all user data is stored in the varai install directory. To
    // use a different location, the following property can be used
    //userDir: '/home/nol/.varai/',

    // varai scans the `nodes` directory in the install directory to find nodes.
    // The following property can be used to specify an additional directory to scan.
    //nodesDir: '/home/nol/.varai/nodes',

    // By default, the varai UI is available at http://localhost:1880/
    ...
    //httpStatic: '/home/nol/varai-dashboard/',
