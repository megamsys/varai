...
describe('Node', function() {
    describe('#constructor',function() {
        ...
        it('is called with an id, a type and a name',function() {
            var n = new VaraiNode({id:'123',type:'abc',name:'barney'});
            n.should.have.property('id','123');
            n.should.have.property('type','abc');
        ...
        it('is called with an id, a type and some wires',function() {
            var n = new VaraiNode({id:'123',type:'abc',wires:['123','456']});
            n.should.have.property('id','123');
            n.should.have.property('type','abc');
            n.should.not.have.property('name');
    ...
    describe('#send', function() {
        ...
        it('emits a single message', function(done) {
            var n1 = new VaraiNode({id:'n1',type:'abc',wires:[['n2']]});
            var n2 = new VaraiNode({id:'n2',type:'abc'});
            var message = {payload:"hello world"};
        ...
        it('emits messages to multiple outputs', function(done) {
            var n1 = new VaraiNode({id:'n1',type:'abc',wires:[['n2'],['n3'],['n4','n5']]});
            var n2 = new VaraiNode({id:'n2',type:'abc'});
            var n3 = new VaraiNode({id:'n3',type:'abc'});
            var n4 = new VaraiNode({id:'n4',type:'abc'});
            var n5 = new VaraiNode({id:'n5',type:'abc'});
        ...
        it('emits messages ignoring non-existent nodes', function(done) {
            var n1 = new VaraiNode({id:'n1',type:'abc',wires:[['n9'],['n2']]});
            var n2 = new VaraiNode({id:'n2',type:'abc'});
